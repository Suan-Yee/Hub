    ...
    deleteButton.addEventListener('click', () => {
        ...
        if (activeItem) {
            ...
            if (img) {
                ...
                console.error('No image found in the active carousel item.');
            }
        } else {
...
function deleteImage(imageSrc) {
    ...
    const itemToDelete = carouselInner.querySelector(`.carousel-item img[src="${imageSrc}"]`).parentElement;
    ...
    if (itemToDelete) {
        ...
        console.error('Image item to delete not found.');
    }
