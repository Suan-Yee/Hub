...
public class GroupServiceImpl implements GroupService {
    ...
    public void createCommunity(GroupDto groupDto, Principal principal) {
        ...
        resultGroupDto.setDeleted(false);
    ...
    public List<GroupDto> findAllGroup() {
        ...
        groupDtoList.forEach(groupDto -> {
            groupDto.setTotalNumber(userHasGroupRepository.totalMembers(groupDto.getId()));
        });
        return groupDtoList;
    }
    ...
    public List<InvitationDto> getAllUserRequest(Principal principal,Long groupId) {
        ...
        return allInvitaion.stream().map(invite -> {
           User requestUser = userService.findById(invite.getRequestId());
            ...
            invitationDto.setRequestUserName(userService.findById(invite.getRequestId()).getName());
            invitationDto.setGroupName(invite.getGroup().getName());
            invitationDto.setGroupId(invite.getGroup().getId());
            invitationDto.setRequestUserStaffId(invite.getRequestId());
            invitationDto.setUserProfile(requestUser.getPhoto());
